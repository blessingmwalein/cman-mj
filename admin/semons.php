                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="120">
                                                        <a rel="tooltip" title="Edit member" id="e<?php echo $id; ?>" href="edit_semons.php<?php echo '?id=' . $id; ?>" data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large"> Edit</i></a>
                                                    </td>
