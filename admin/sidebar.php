   <style>
     ...
     #finance-dropdown>li:first-child>a {}

     #finance-dropdown>li:last-child>a {}

     #finance-dropdown>.active>a {
       position: relative;
       z-index: 2;
       padding: 9px 15px;
       border: 0;
     ...
     /* Chevrons */
     #finance-dropdown .icon-chevron-right {
       float: right;
       margin-top: 2px;
       margin-right: -6px;
       opacity: .25;
     ...
     #finance-dropdown>li>a:hover {
       background-color: #f5f5f5;
     }

     #finance-dropdown a:hover .icon-chevron-right {
       opacity: .5;
     }

     #finance-dropdown .active .icon-chevron-right,
     #finance-dropdown.active a:hover .icon-chevron-right {
       opacity: 1;
     }

     #finance-dropdown.affix {
       top: 40px;
     }

     #finance-dropdown.affix-bottom {
       position: absolute;
       top: auto;
       bottom: 270px;
     }
   ...
   <div class="span3" id="sidebar">
     <img id="admin_avatar" class="img-circle" src="img/none.png">
     ...
     <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
       ...
       <li>
         <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#finance-dropdown"><i class="icon-chevron-right"></i><i class="icon-money"></i>&nbsp;Manage Finances
           <div class="muted pull-right"><i class="caret"></i></div>
         </a>
         <ul id="finance-dropdown" class="collapse">
           <li class="">
             <a href="finance_types.php"><i class="icon-chevron-right"></i><i class="icon-money"></i> Finance Types</a>
           </li>
           <li class="">
             <a href="finances.php"><i class="icon-chevron-right"></i><i class="icon-money"></i>Finacials</a>
           </li>
           <li class="">
             <a href="currencies.php"><i class="icon-chevron-right"></i><i class="icon-money"></i>Currencies</a>
           </li>
         </ul>
       </li>
       ...
       <li>
         ...
         <ul id="bs5" class="collapse">
           ...
           <li class="">
             <a href="semons.php"><i class="icon-chevron-right"></i><i class="icon-book"></i>Semons</a>
           </li>
           <li class="">
