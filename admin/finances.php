        ...
        <div class="row-fluid">
            ...
            <div class="span6" id="">
                <div class="row-fluid">
                    ...
                    <?php
                    $count_finances = mysqli_query($conn, "select * from  finance");
                    ...
                    <div id="block_bg" class="block">
                        ...
                        <div class="block-content collapse in">
                            <div class="span12">
                            <!-- <a  title="Click to Update Transaction Details" href="update_finances_status.php" id="update_transactions" class="btn btn-success" name=""> Update Transaction Details</i></a> -->
                                ...
                                <form action="delete_memberss.php" method="post">
                                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                        ...
                                        <tbody>
                                            ...
                                            $finances_query = mysqli_query($conn, "select * from finance INNER JOIN finance_type ON finance.finance_type_id=finance_type.id") or die(mysqli_error());
