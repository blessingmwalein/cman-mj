    <style>
      ...
      #finances-drop>li:first-child>a {}

      #finances-drop>li:last-child>a {}

      #finances-drop>.active>a {
        position: relative;
        z-index: 2;
        padding: 9px 15px;
        border: 0;
      ...
      /* Chevrons */
      #finances-drop .icon-chevron-right {
        float: right;
        margin-top: 2px;
        margin-right: -6px;
        opacity: .25;
    ...
    <div class="span3" id="sidebar">
      ...
      <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
        ...
        <li>
          <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs"><i class="icon-chevron-right"></i><i class="icon-user"></i>&nbsp;Manage Account
            <div class="muted pull-right"><i class="caret"></i></div>
          </a>
          <ul id="bs" class="collapse">
            <li class="">
              <a href="semons.php"><i class="icon-chevron-right"></i><i class="icon-user"></i>Semons</a>
            </li>
          </ul>
        </li>
        ...
        <li>
          <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#finances-drop"><i class="icon-chevron-right"></i><i class="icon-globe"></i>&nbsp;Financials
            <div class="muted pull-right"><i class="caret"></i></div>
          </a>
          <ul id="finances-drop" class="collapse">
            <li class="">
              <a href="finances.php"><i class="icon-chevron-right"></i><i class="icon-money"></i> Finances</a>
            </li>
          </ul>
        </li>
